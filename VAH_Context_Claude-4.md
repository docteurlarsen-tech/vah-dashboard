...
## 15. LA PLATEFORME — 11 BRANCHES

### Principe fondamental
L'OV n'est pas juste un système de gestion du VAH.
C'est une infrastructure modulaire universelle.
1 infrastructure · 11 branches · marchés infinis.
Le VAH est le laboratoire qui prouve tout ça.
Dak'Art 2028 est la démonstration publique.
Post-2028 est le déploiement commercial.

### Branches déjà construites
```
OV — Ordinateur Virtuel
Infrastructure de gouvernance · cœur du système
Déjà déployé · agent Telegram · dashboard CPU · copyright Michael

VAH Track
Traçabilité QR · certification actifs physiques
3 objets de départ : bois Ngoltongo · collection Charles · pièces VAH
Extensions : Affiliés · Botanica · Parcours visite
Marché : artisans · lodges · galeries · médecine · agriculture · BTP
```

### Branches dérivables directement
```
VAH Craft     → e-commerce artisanat africain premium
               Shopify + OV + VAH Track + certification origine

VAH Learn     → formation hybride
               Présentiel atelier + modules numériques + certification
               Artisans · FabLabs · universités

VAH Space     → gestion espaces culturels et créatifs
               Lodges · résidences · ateliers · galeries
               Réservations · événements · revenus

VAH Bot       → agent conversationnel comme produit autonome
               N'importe quelle organisation déploie son propre
               agent de gouvernance

VAH Sensor    → réseau capteurs embarqués Arduino
               Ateliers · territoires · bâtiments
               Monitoring · alertes · données temps réel

VAH Light     → pilotage installations lumière
               Événementiel · art · architecture
               Christian Toons comme prototype

VAH Flora     → documentation patrimoniale botanique
               Jardins · réserves · territoires naturels
               Ngoltongo comme prototype

VAH Med       → traçabilité médicale zones rurales
               Médicaments · équipements · dossiers patients

VAH Agri      → traçabilité agricole ferme au marché
               Semences · récoltes · certifications bio

VAH City      → gouvernance territoriale collectivités
               Smart cities africaines à échelle humaine
```

### VAH Track — détail technique
```
Structure Firebase :
/objets/{objectId}/
  type         : bois | art | piece | materiau
  photos       : [url1, url2, url3]
  statut       : en_stock | reserve | production | livre
  histoire     : [événements horodatés]
  metadonnees  : dimensions · poids · essence · origine
  proprietaire : charles | vah | client
  valeur       : estimation

QR Code → URL unique vah.io/objet/{objectId}
Accessible depuis n'importe quel téléphone · sans app
Dashboard CPU → vue globale stock · alertes · filtres
```

### Ce que ça change pour le document FDE
Page 2 et Page 3 à enrichir avec :
— Les 11 branches et leur logique modulaire
— VAH Track comme premier produit dérivé
— Le marché de chaque branche
— La valeur de l'infrastructure pour les investisseurs

STATUT : À intégrer dans le document FDE — prochaine étape
